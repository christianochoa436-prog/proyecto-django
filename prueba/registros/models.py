...
class Alumnos(models.Model): #Define la escritura de nuestra tabla
    ...
    class Meta:
        ...
        ordering = ["-created"]
        #el menos inidica que se ordenara del mas reciente al mas viejo
...
def __str__(self):
        return self.coment
    #Indica que se mostrara el comentario como valor en la tabla
